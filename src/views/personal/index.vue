<template>
  <div class="main-container">
    <div class="box-wrapper">
      <div class="flex">
        <a-card class="box-card personal-box" :content-style="{ padding: '10px' }">
          <div class="info-wrapper">
            ...
            <div class="mt-4">
              <a-space align="center" :style="{ flexWrap: 'wrap' }">
                <a-tag color="success" size="small">技术控</a-tag>
                <a-tag color="success" size="small">爱学习</a-tag>
                <a-tag color="success" size="small">大嘴巴</a-tag>
                <a-tag color="success" size="small">宅男</a-tag>
                <a-tag color="success" size="small">嘚嘚没完</a-tag>
                <a-tag color="success" size="small">UP主</a-tag>
                <a-tag color="success" size="small">手机控</a-tag>
              </a-space>
            </div>
          </div>
        </a-card>
        <a-card
          title="待办事项"
          class="flex-1 box-card wating-box"
        ...
        >
          <div v-for="(item, index) of watingJobs" :key="index" class="flex wating-item">
            ...
            <div style="width: 40px">
              <a-tag :color="item.status === 0 ? 'error' : 'success'" size="mini">
      ...
      <div class="mt-2">
        <a-card title="消息中心" class="box-card flex-sub" :content-style="{ padding: '10px' }">
          <template #extra>
