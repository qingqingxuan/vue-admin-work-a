<template>
  <div>
      ...
      <div class="flex form-wrapper">
        ...
        <div class="right">
          <div class="flex justify-center my-width flex-sub align-center">
            ...
            <div class="title margin-left">Vue Admin Work A</div>
          </div>
    ...
    <div v-else class="m-login-container">
      ...
      <div class="content">
        <a-input round placeholder="请输入用户名/手机号" size="large" v-model:value="username">
          <template #prefix>
            <PhoneIcon />
          </template>
        </a-input>
        ...
        <a-button class="mt-20" round type="primary" block :loading="loading" @click="onLogin">
          登录
        </a-button>
        <div class="flex justify-between mt-4">
          <a-checkbox v-model:checked="autoLogin" color="#fff">自动登录</a-checkbox>
